...
@click.command("find_gene", help="According to the results of GWAS, the genes of upstream and downstream 1M of SNP locus were selected.")
@click.option(
...
@click.option("-o", "--out",default="find_gene_out.txt",type=str,help="Output file (default 'find_gene_out.txt')")
def find_gene(gff,position,width,out):
	"""
